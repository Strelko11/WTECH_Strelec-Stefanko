...
<body class="flex flex-col min-h-screen bg-gray-50">
    ...
    <div class="w-full max-w-[90%] mx-auto px-6 py-10 border-l border-r border-gray-500 custom-shadow mt-4 rounded-md bg-gray-100">
        ...
        <div class="flex flex-wrap justify-center gap-10 max-w-[100%] mx-auto">
            <!-- Iphone -->
            <a href="{{ route('strankaProdukty') }}" class="bg-white p-4 rounded-lg flex items-center space-x-2 shadow-md w-full max-w-[380px] h-40 border border-gray-400 hover:text-black hover:scale-105 transition-all duration-300 ease-in-out">
                <div class="h-38 w-38 rounded bg-white bg-[url('https://pngimg.com/d/iphone16_PNG38.png')] bg-contain bg-no-repeat bg-center"></div>
                <span class="text-2xl text-center">Iphone</span>
            </a>

            <!-- Samsung -->
            <a href="{{ route('strankaProdukty') }}" class="bg-white p-4 rounded-lg flex items-center space-x-2 shadow-md w-full max-w-[380px] h-40 border border-gray-400 hover:text-black hover:scale-105 transition-all duration-300 ease-in-out">
                <div class="h-38 w-38 rounded bg-white bg-[url('https://s7d1.scene7.com/is/image/dish/S25_Icyblue_Hero_P1?$ProductBase$&fmt=webp-alpha')] bg-contain bg-no-repeat bg-center"></div>
                <span class="text-2xl text-center">Samsung</span>
            </a>

            <!-- Xiaomi -->
            <a href="{{ route('strankaProdukty') }}" class="bg-white p-4 rounded-lg flex items-center space-x-2 shadow-md w-full max-w-[380px] h-40 border border-gray-400 hover:text-black hover:scale-105 transition-all duration-300 ease-in-out">
                <div class="h-38 w-38 rounded bg-white bg-[url('https://www.geekwills.com/media/catalog/product/cache/d368225e56c0af8fed569f12698f474d/x/i/xiaomi_15.png')] bg-contain bg-no-repeat bg-center"></div>
