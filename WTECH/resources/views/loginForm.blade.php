    ...
    <div class="w-full max-w-[60%] h-auto mx-auto px-4 py-10 border-l border-r border-gray-400 custom-shadow mt-22 flex items-center justify-center rounded-md">
        <form class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
            ...
            <div class="mb-4">
                ...
                <a href="#" class="block w-full text-center mt-4 mb-4 text-blue-500 hover:underline">
                    Zabudnuté heslo?
                </a>
            <button type="submit" class="w-3/5 bg-gray-400 hover:bg-gray-500 text-white font-semibold py-2 px-4 rounded-lg mt-4  transition mx-auto block">
                Potvrdiť
            </button>

            <a href="{{ route('registerForm') }}" class="block w-full text-center mt-10  text-blue-500 hover:underline ml-auto">
                Nová registrácia
            </a>
