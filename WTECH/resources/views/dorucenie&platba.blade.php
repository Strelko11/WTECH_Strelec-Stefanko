...
<body class="min-h-screen flex flex-col bg-gray-100">
  ...
  <div class="flex-grow flex flex-col items-center mt-24"> <!-- Added margin-top to push content down -->
    ...
    <form action="{{ route('cart.clear') }}" method="POST" id="orderForm" class="w-full max-w-[80%] flex flex-col items-center space-y-8 mt-20">
      @csrf
      @method('DELETE')
      ...
      <!-- Payment Method -->
      <div class="w-full md:max-w-[65%] px-4 md:px-8 py-6 md:py-10 mt-6 shadow-xl flex flex-col gap-6 rounded-lg bg-white border border-gray-300">
