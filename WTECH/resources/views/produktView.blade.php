...
<body class="flex flex-col min-h-screen bg-gray-100">
    <div class="flex-grow">
        ...
        <div
            class="w-full max-w-[90%] mx-auto px-4 py-10 border-l border-r border-gray-400 custom-shadow mt-22 rounded-md">
            <div class="flex flex-col md:flex-row gap-6 items-start">
                <div class="w-full md:w-1/2 flex flex-col items-center">
                    <div
                        class="cursor-pointer relative h-80 md:h-96 bg-white flex items-center justify-center rounded-lg  overflow-hidden w-full border border-gray-400">
                        <img id="main-image" src="{{ $product->images->first()
    ? Storage::url($product->images->first()->image_url)
    : asset('default.jpg') }}" alt="Fotka produktu"
                    ...
                    <div class="flex gap-2 md:gap-4 mt-4 justify-center">
                        @foreach($product->images as $index => $image)
                            <div
                                class="w-16 md:w-20 h-12 md:h-16 bg-white rounded-lg flex items-center justify-center border border-gray-400">
                ...
                <div class="w-full md:w-1/2 flex flex-col gap-4 items-center text-center">
                    ...
                    <div class="flex flex-wrap gap-4 w-full justify-center md:justify-start">
                        ...
                        <div id="total-price"
                            class="bg-gray-200 rounded-lg p-4 text-lg border border-gray-400 font-semibold w-full sm:w-[350px] md:w-[300px] lg:w-[200px] text-center"
                        ...
                        <div
                            class="quantity-container flex items-center gap-4 w-full sm:w-[350px] md:w-[300px] lg:w-[200px]">
                            <button class="quantity-btn bg-gray-200 border-gray-400 p-2 rounded-full w-12 h-12 text-xl"
                                id="decrease">−</button>
                            <input type="text" id="quantity" value="1"
                                class="text-center w-[50px] sm:w-[60px] bg-white border border-gray-400 rounded-lg text-lg font-semibold">
                            <button class="quantity-btn bg-gray-200 border-gray-400 p-2 rounded-full w-12 h-12 text-xl"
                                id="increase">+</button>
                        </div>
                        ...
                        @auth
                            @if (Auth::user()->role === 'admin')
                                <div
                                    class="bg-gray-400 border border-gray-500 text-white text-lg font-semibold px-6 py-3 rounded-lg w-full sm:w-[250px] md:w-[300px] lg:w-[210px] text-center cursor-not-allowed">
                            ...
                            @else
                                <form method="POST" action="{{ route('cart.add', $product->id) }}">
                                    ...
                                    <button type="submit"
                                        class="bg-gray-600 hover:bg-gray-800 border border-gray-400 text-white text-lg font-semibold px-6 py-3 rounded-lg w-full sm:w-[250px] md:w-[300px] lg:w-[210px]">
                                        Do košíka
                                    </button>
                                </form>
                            @endif
        ...
        <div id="gallery-modal" class="fixed inset-0 z-50 p-4 bg-gray-300 bg-opacity-80 items-center justify-center
            opacity-0 scale-95 pointer-events-none transition-all duration-300 flex">
            <div
                class="relative flex flex-col items-center max-w-[90%] max-h-[90vh] bg-white p-4 rounded-lg shadow-lg w-[700px] md:w-[800px] lg:w-[900px]">
        ...
        <div
            class="w-full max-w-[90%] mx-auto px-4 py-6 border-l border-r border-gray-400 custom-shadow mt-6 rounded-md">
